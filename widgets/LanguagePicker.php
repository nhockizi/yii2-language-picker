...
namespace nhockizi\languagepicker\widgets;
...
class LanguagePicker extends \yii\base\Widget
{
     ...
     */
    private $_SIZES = [
        self::SIZE_SMALL => 'nhockizi\languagepicker\bundles\LanguageSmallIconsAsset',
        self::SIZE_LARGE => 'nhockizi\languagepicker\bundles\LanguageLargeIconsAsset',
    ];
     ...
     */
    public $languagePluginAsset = 'nhockizi\languagepicker\bundles\LanguagePluginAsset';
